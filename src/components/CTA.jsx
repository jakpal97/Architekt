    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <h2 className="text-5xl md:text-7xl font-medium mb-8 leading-tight">
          ...
          <br />
          About Architecture Project?
        </h2>
        <p className="text-gray-300 text-lg mb-12 max-w-2xl mx-auto">
          Their ability balance modern design with sustainability resulted in beautiful, functional space that
          reflects our values. Exploring how architecture can blur the lines.
        </p>
