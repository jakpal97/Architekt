				...
				<div className="w-full md:w-2/3 flex flex-col justify-between">
					<div>
						...
						<p className="text-gray-600 max-w-xl">
							Integrating the natural environment with architectural design through outdoor space planning. Designing
							buildings with energy efficiency in mind.
						</p>
					</div>
			...
			<div className="service-item border-t border-gray-300 py-12 flex flex-col md:flex-row gap-12">
				...
				<div className="w-full md:w-2/3 flex flex-col justify-between md:order-1">
					<div>
						...
						<p className="text-gray-600 max-w-xl">
							Designing functional, aesthetically pleasing interiors that complement architecture. Planning
							multi-building projects and campus designs.
						</p>
					</div>
					<button className="mt-8 border border-black w-fit rounded-full px-6 py-2 text-sm flex items-center gap-2 hover:bg-black hover:text-white transition">
						Service Details →
