	...
	return (
		<section className="relative bg-white z-20 pt-24 pb-24 px-6 md:px-12" id="project-list">
			<div className="max-w-7xl mx-auto">
				<h3 className="text-3xl mb-12">Najnowsze Projekty</h3>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
					<div className="group cursor-pointer">
						...
						<h4 className="text-2xl font-medium">Willa Rezydencjalna</h4>
						<p className="text-gray-500">Architektura / Polska</p>
					</div>
					<div className="group cursor-pointer mt-12 md:mt-24">
						<div className="overflow-hidden rounded-xl mb-4">
							<img
								...
								className="w-full h-[400px] object-cover group-hover:scale-105 transition duration-700"
								alt="Luksusowe Wnętrza"
							/>
						</div>
						<h4 className="text-2xl font-medium">Luksusowe Wnętrza</h4>
						<p className="text-gray-500">Design / Polska</p>
					</div>
				</div>
			</div>
		</section>
