...
export default function ServicesNavbar() {
  return (
    <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-8 py-6 bg-white/90 backdrop-blur-sm border-b border-gray-100 transition-all duration-300">
      ...
      <div className="hidden md:flex gap-8 text-sm font-medium uppercase tracking-wide">
        ...
        <Link href="/uslugi" className="text-black font-bold">Services</Link>
        <a href="#" className="hover:opacity-60 transition">Blog</a>
      </div>
      <a
        href="#"
